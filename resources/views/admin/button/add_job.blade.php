          ...
          <form action="{{ route('admin.job.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name="category" id="">
                @foreach($categories as $c)<option value="{{ $c->id }}"> {{ $c->category }} </option>@endforeach
              </select>
            ...
            <div class="form-group">
              ...
              <input class="au-input au-input--full" type="text" name="years_of_experience" placeholder="Years Of Experience">
            </div>
            <br>
            <div class="form-group">
              <label>Type</label>
